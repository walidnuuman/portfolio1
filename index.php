...
<head>
    ...
    <title>Nuuman | Software engineering student</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <section id="hero" class="hero section">
        <div class="container hero-content">
            ...
            <p>Im a software engineering student with a good experience in web develobment also still learning full stack developement,databases and mordern technologies</p>
            <div class="hero-cta">
                <a href="#projects" class="btn btn-primary">What i have done</a>
    ...
    <section id="contact" class="section">
        <div class="container">
            ...
            <p class="section-subtitle">Have an idea in mind? Let's talk.</p>
            ...
            <div class="contact-wrapper">
                <form id="contact-form" class="contact-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" placeholder="nuuman danbatta">
                        <small class="error-msg">Name is required</small>
                    </div>
                    
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" placeholder="nuuann05@gmail.com">
